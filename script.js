...
const TEAMS = [
  {name:"Brasil",code:"BRA",flag: BRA },{name:"Argentina",code:"ARG",flag: ARG },
  {name:"França",code:"FRA",flag: FRA },{name:"Alemanha",code:"GER",flag: GER },
  {name:"Espanha",code:"ESP",flag: ESP },{name:"Portugal",code:"POR",flag:POR},
  {name:"Inglaterra",code:"ENG",flag: ENG },{name:"Itália",code:"ITA",flag:ITA},
  {name:"Países Baixos",code:"NED",flag:NED},{name:"Bélgica",code:"BEL",flag:BEL},
  {name:"Uruguai",code:"URU",flag:URU},{name:"Croácia",code:"CRO",flag:CRO},
  {name:"México",code:"MEX",flag:MEX},{name:"Estados Unidos",code:"USA",flag:USA},
  {name:"Colômbia",code:"COL",flag:COL},{name:"Senegal",code:"SEN",flag:SEN},
  {name:"Marrocos",code:"MAR",flag:MAR},{name:"Japão",code:"JPN",flag:JPN},
  {name:"Coreia do Sul",code:"KOR",flag:KOR},{name:"Austrália",code:"AUS",flag:AUS},
  {name:"Canadá",code:"CAN",flag:CAN},{name:"Suíça",code:"SUI",flag:SUI},
  {name:"Dinamarca",code:"DEN",flag:DEN},{name:"Polônia",code:"POL",flag:POL},
  {name:"Sérvia",code:"SRB",flag:SRB},{name:"Gana",code:"GHA",flag:GHA},
  {name:"Camarões",code:"CMR",flag:CMR},{name:"Tunísia",code:"TUN",flag:TUN},
  {name:"Equador",code:"ECU",flag:ECU},{name:"Chile",code:"CHI",flag:CHI},
  {name:"Peru",code:"PER",flag:PER},{name:"Paraguai",code:"PAR",flag:PAR},
  {name:"Venezuela",code:"VEN",flag:VEN},{name:"Costa Rica",code:"CRC",flag:CRC},
  {name:"Panamá",code:"PAN",flag:PAN},{name:"Jamaica",code:"JAM",flag:JAM},
  {name:"Arábia Saudita",code:"KSA",flag:KSA},{name:"Irã",code:"IRN",flag:IRN},
  {name:"Catar",code:"QAT",flag:QAT},{name:"Emirados Árabes",code:"UAE",flag:UAE},
  {name:"Iraque",code:"IRQ",flag:IRQ},{name:"Nova Zelândia",code:"NZL",flag:NZL},
  {name:"Egito",code:"EGY",flag:EGY},{name:"Argélia",code:"ALG",flag:ALG},
  {name:"Nigéria",code:"NGA",flag:NGA},{name:"África do Sul",code:"RSA",flag:RSA},
  {name:"Costa do Marfim",code:"CIV",flag:CIV},{name:"Cabo Verde",code:"CPV",flag:CPV},
  {name:"Escócia",code:"SCO",flag:SCO},{name:"País de Gales",code:"WAL",flag:WAL},
  {name:"Irlanda",code:"IRL",flag:IRL},{name:"Áustria",code:"AUT",flag:AUT},
  {name:"Suécia",code:"SWE",flag:SWE},{name:"Noruega",code:"NOR",flag:NOR},
  {name:"Turquia",code:"TUR",flag:TUR},{name:"Ucrânia",code:"UKR",flag:UKR},
  {name:"República Tcheca",code:"CZE",flag:CZE},{name:"Hungria",code:"HUN",flag:HUN},
  {name:"Romênia",code:"ROU",flag:ROU},{name:"Grécia",code:"GRE",flag:GRE},
  {name:"Eslováquia",code:"SVK",flag:SVK},{name:"Eslovênia",code:"SVN",flag:SVN},
  {name:"Finlândia",code:"FIN",flag:FIN},{name:"Islândia",code:"ISL",flag:ISL},
  {name:"Honduras",code:"HON",flag:HON},{name:"Bolívia",code:"BOL",flag:BOL},
  {name:"Bósnia e Herzegovina",code:"BIH",flag:BIH},{name:"Trinidad e Tobago",code:"TRI",flag:TRI},
  {name:"Jordânia",code:"JOR",flag:JOR},{name:"Argélia",code:"AGL",flag:AGL},
  {name:"Uzbequistão",code:"UZB",flag:UZB}, {name:"RD Congo",code:"COD",flag:COD}
];
